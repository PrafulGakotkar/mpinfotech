                        ...
                        <div className="col-lg-6 pt-60">
                            ...
                            <div className="mb-5">
                                ...
                                <div className="about-me mb-30 ">
                                    ...
                                    <p> <i className="fa fa-circle" style={{ fontSize: "7px", color: "blue" }}></i> Report of Vulnerabilities & Threats associated with the Applications</p>
                                    <p><i className="fa fa-circle" style={{ fontSize: "7px", color: "blue" }}></i>  Report of Risks Identified and Mitigation Controls</p>
                                    <p><i className="fa fa-circle" style={{ fontSize: "7px", color: "blue" }}></i>  Assess Residual Risk and provide Risk Mitigation Strategy</p>
