                        ...
                        <div className="col-lg-6 pt-60">
                            ...
                            <div className="mb-5">
                                <div className="widget-title-box mb-30">
                                    ...
                                    <p>Few areas that we can help but not limited to
                                ...
                                <div className="about-me mb-30 ">
                                    ...
                                    <p> <i className="fa fa-circle" style={{ fontSize: "7px", color: "blue" }}></i> Report of Exposed Vulnerabilities & Threats on the Network</p>
                                    <p><i className="fa fa-circle" style={{ fontSize: "7px", color: "blue" }}></i>  Information of Required Patches</p>
                                    <p><i className="fa fa-circle" style={{ fontSize: "7px", color: "blue" }}></i>  Report of Assets Breached</p>
                                    <p><i className="fa fa-circle" style={{ fontSize: "7px", color: "blue" }}></i> Remediation Strategy</p>
                                    <p><i className="fa fa-circle" style={{ fontSize: "7px", color: "blue" }}></i>  Security Posture Improvement Techniques</p>
