          ...
          <div className="row">
            <div className="col-xl-8 col-lg-8 offset-lg-2 offset-xl-2">
              <div className="section-title text-center ml-50 mr-50 mb-80">
                ...
                <h1>Our Customer Challenges</h1>
                <h6></h6>The sprint to multiple cloud environments has created challenges
              </div>
            </div>
          </div>
          <div className="row">
            {/* {serviceDataTwo.map((item) => (
              ...
              <div  className="col-xl-4 col-lg-4 col-md-6 mb-30">
                <div className="services-wrapper text-center">
                  ...
                  <div className="services-text">
                    <h3> Confidence that the business value outweighs the risk </h3>
              ...
              <div  className="col-xl-4 col-lg-4 col-md-6 mb-30">
                <div className="services-wrapper text-center">
                  ...
                  <div className="services-text text-center">
                    <h3>What to move, where to move it and when to move it
</h3>
                    {/* <p> Founder & CEO</p> */}
              ...
              <div  className="col-xl-4 col-lg-4 col-md-6 mb-30">
                <div className="services-wrapper text-center">
                  ...
                  <div className="services-text text-center ">
                    <h5> The knowledge and resource availability to build an outcome-based cloud journey management plan that enables you to think big and move fast </h5>
