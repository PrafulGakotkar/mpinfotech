                    ...
                    <div className="row  " >
                        ...
                        <div className="col-lg-6" >
                            ...
                            <div className="mb-40 ">
                                ...
                                <ul>
                                    <li><i className="fa fa-circle" style={{fontSize:"7px", color:"blue"}}></i> Define, govern and measure the compliance of our customer’s clouds in a unified way.</li>
                                    <li><i className="fa fa-circle" style={{fontSize:"7px", color:"blue"}}></i> Track the cloud resources, manage costs and detect security events, based on misconfigurations, threats and changes.</li>
                                    <li><i className="fa fa-circle" style={{fontSize:"7px", color:"blue"}}></i> Cost management of multi-cloud infrastructure, identifying value of service.</li>
                                    <li><i className="fa fa-circle" style={{fontSize:"7px", color:"blue"}}></i> Cloud-Ops dashboard helps promote action on risks and mitigate them in a timely manner.</li>
                                    <li><i className="fa fa-circle" style={{fontSize:"7px", color:"blue"}}></i> Reporting capability provides the needed visibility to Senior management and other stake holders.</li>
                                </ul>
